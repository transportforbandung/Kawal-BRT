...
(function () {
  ...
  const pointLayerConfigs = [
    ...
    },
    {
      ...
      defaultEnabled: true,
      typeStyles: {
        'Tepi Jalan': { radius: 9, color: '#00568E', fillColor: '#5BACD4', fillOpacity: 0.9, weight: 2 },
        'Median Jalan': { radius: 9, color: '#007A3D', fillColor: '#00A651', fillOpacity: 0.9, weight: 2 },
      },
